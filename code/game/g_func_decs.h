...
extern gentity_t * weapon_grenadelauncher_fire_coop ( gentity_t * ent , int grenType ) ;
...
extern qboolean G_IsEntityAI ( gentity_t * entity ) ;
extern qboolean G_IsEntityDead ( gentity_t * entity ) ;
extern gentity_t * GetFirstValidAlliedPlayer ( qboolean checkHealth ) ;
extern gentity_t * GetFirstValidPlayer ( qboolean checkHealth ) ;
extern qboolean ScriptEventForPlayer ( gentity_t * activator , char * eventStr , char * params ) ;
extern qboolean IsPlayerEnt ( gentity_t * ent ) ;
...
extern void SP_trigger_exfil ( gentity_t * self ) ;
extern void Touch_exfil ( gentity_t * self , gentity_t * other , trace_t * trace ) ;
extern void Use_exfil ( gentity_t * self , gentity_t * other , gentity_t * activator ) ;
...
extern void SaveIP ( gclient_t * client , char * sip ) ;
...
extern void cmd_gamelocked ( gentity_t * ent , qboolean unlock ) ;
...
extern void cmd_ban ( gentity_t * ent ) ;
extern void cmd_clientkick ( gentity_t * ent ) ;
extern void cmd_kick ( gentity_t * ent ) ;
extern void cmd_clientUnignore ( gentity_t * ent ) ;
extern void cmd_clientIgnore ( gentity_t * ent ) ;
extern void cmd_unignore ( gentity_t * ent ) ;
extern void cmd_ignore ( gentity_t * ent ) ;
...
extern qboolean isHigher ( gentity_t * ent , gentity_t * targ ) ;
...
extern void admCmds ( const char * strCMD1 , char * strCMD2 , char * strCMD3 , qboolean cmd ) ;
extern int ClientNumberFromString2 ( gentity_t * to , char * s ) ;
...
extern int checkBanned ( char * data , char * password ) ;
...
extern void PrintMaxLivesGUID ( void ) ;
#endif
...
extern void G_SpawnExtraGEntityFromSpawnVars ( void ) ;
...
extern qboolean G_ScriptAction_NumSecrets ( gentity_t * ent , char * params ) ;
extern qboolean G_ScriptAction_ObjectiveMet ( gentity_t * ent , char * params ) ;
...
extern void SP_coop_spawnpoint_trigger ( gentity_t * ent ) ;
extern void spawnpoint_trigger_touch ( gentity_t * self , gentity_t * other , trace_t * trace ) ;
extern void spawnpoint_trigger_think ( gentity_t * self ) ;
extern void spawnpoint_trigger_use ( gentity_t * ent , gentity_t * other , gentity_t * activator ) ;
extern void Coop_AddStats ( gentity_t * targ , gentity_t * attacker , int dmg_ref , int mod ) ;
extern void Coop_DeleteStats ( int clientnum ) ;
extern gentity_t * SelectRandomCoopSpawnPoint ( vec3_t origin , vec3_t angles ) ;
extern gentity_t * SelectRandomAntiCoopSpawnPoint ( gentity_t * ent , vec3_t origin , vec3_t angles ) ;
...
extern void SetTeam ( gentity_t * ent , const char * s , qboolean force ) ;
extern int TeamCount( int ignoreClientNum, team_t team );
...
extern void Cmd_PlayerStart_f ( gentity_t * ent ) ;
extern void DeathmatchScoreboardMessage ( gentity_t * ent ) ;
extern qboolean G_IsClientInTeamState ( gentity_t * entity , playerTeamStateState_t state ) ;
extern qboolean G_IsClientOnTeam ( gentity_t * entity , team_t team ) ;
extern qboolean G_IsClientDead ( gentity_t * entity ) ;
extern qboolean G_IsClientAI ( gentity_t * entity ) ;
extern qboolean G_IsClient ( gentity_t * entity ) ;
...
extern void SetCoopSkin ( gclient_t * client , char * model , int number ) ;
...
extern qboolean AICast_ScriptAction_NumSecrets ( cast_state_t * cs , char * params ) ;
...
extern qboolean AICast_ScriptAction_PlayerName ( cast_state_t * cs , char * params ) ;
...
extern void G_MapLandmineArm ( gentity_t * self ) ;
extern void G_MapLandmineThink ( gentity_t * self ) ;
extern void G_MapLandminePostThink ( gentity_t * self ) ;
extern void G_MapLandmineExplode ( gentity_t * self ) ;
