...
typedef enum {
	...
	WEAPON_HOLSTER_IN,  // g_realism: lowering weapon to climb a ladder
	WEAPON_HOLSTER_OUT, // g_realism: raising weapon after leaving a ladder
	WEAPON_SPRINT_IN,   // g_realism: lowering weapon to sprint
	WEAPON_SPRINT_OUT   // g_realism: raising weapon after sprinting
} weaponstate_t;
...
#define PMF_SPRINTING       128     // player is actively sprinting (g_realism)
...
#define EF_FROZEN           EF_BOUNCE_HEAVY // if g_freeze is on, freeze players after respawn
...
typedef struct ammotable_s {
	...
	float moveSpeed;       // g_realism: movement speed scale while this weapon is equipped
...
#define WP_LASTSECONDARY    WP_DELISLESCOPE
...
typedef enum {
	...
	EV_SNIPER_SOUND,
	EV_POPUP_CLIPBOARD, // Was EV_POPUP, but this is more descriptive.
	EV_POPUP_BOOK,
...
typedef enum {
	...
	WEAPON_CLASS_PISTOL             = (1 << 1),
	WEAPON_CLASS_SMG                = (1 << 2),
	WEAPON_CLASS_RIFLE_AUTO         = (1 << 3),
	WEAPON_CLASS_ASSAULT_RIFLE      = (1 << 4),
	WEAPON_CLASS_SHOTGUN            = (1 << 5),
	WEAPON_CLASS_GRENADE            = (1 << 6),
	WEAPON_CLASS_RIFLENADE          = (1 << 7),
	WEAPON_CLASS_MG                 = (1 << 8),
	WEAPON_CLASS_LAUNCHER           = (1 << 9),
	WEAPON_CLASS_FLAMER             = (1 << 10),
	WEAPON_CLASS_SCOPED             = (1 << 11),
	WEAPON_CLASS_SCOPABLE           = (1 << 12),
	WEAPON_CLASS_AKIMBO             = (1 << 13),
	WEAPON_CLASS_MINIGUN            = (1 << 14),
	WEAPON_CLASS_ENERGY             = (1 << 15),
	WEAPON_CLASS_DYNAMITE           = (1 << 16),
	WEAPON_CLASS_RIFLE_BOLTACTION   = (1 << 17),
	WEAPON_CLASS_LANDMINE           = (1 << 18),
	WEAPON_CLASS_MEDCRATE           = (1 << 19),
} weaponClass_t;
...
// to send the class name with event. maps are defined in classNameMap[] (cg_event.c)
typedef enum
{
	COOP_SPAWNPOINT,
	AI_TRIGGER
