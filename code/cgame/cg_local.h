...
typedef struct {
	...
	// MDM/MDX: which animation oldFrame was computed against, since it can briefly differ from `animation`; unused for .mds
...
//----(SA) end
	...
	sfxHandle_t reloadSoundFast;        // PERK_WEAPONHANDLING partial reload sound
	...
	sfxHandle_t fireModeSwitchSound;    // played when the player toggles semi/full-auto
} weaponInfo_t;
...
extern vmCvar_t cg_gunAnglePitch;
extern vmCvar_t cg_gunAngleYaw;
extern vmCvar_t cg_gunAngleRoll;
extern vmCvar_t cg_gunSwayIdleSpeed;
extern vmCvar_t cg_gunSwayIdleAmp;
extern vmCvar_t cg_gunSwayAmp;
extern vmCvar_t cg_gunSwayDip;
extern vmCvar_t cg_gunSwayRoll;
extern vmCvar_t cg_gunSwayLower;
extern vmCvar_t cg_gunSwayCenter;
extern vmCvar_t cg_gunSwaySprintScale;
